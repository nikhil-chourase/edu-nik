...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "fec9f1d4-caca-4aa4-bded-ee51ddf7dcd3");
    ...
    <div className='contact'>
        <div className="contact-col">
            ...
            <ul>
                ...
                <li><img src={location_icon} alt="" /> 77 Massachusetts Ave, Cambridge<br/> MA 02139, UnitedStates</li>
            </ul>
        </div>
        <div className="contact-col">
